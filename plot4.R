...
plot(assignment1$DT, assignment1$Global_active_power, ylab = 'Global Active Power (kilowatt)', type = 'l',xlab="")
plot(assignment1$DT, assignment1$Voltage, ylab = 'Voltage', type = 'l',xlab="datetime")
...
plot(assignment1$DT, assignment1$Global_reactive_power, ylab = 'Global_reactive_power', type = 'l',xlab="datetime")
dev.off()